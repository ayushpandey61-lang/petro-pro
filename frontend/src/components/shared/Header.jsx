...
const Header = () => {
  ...
  return (
    <header
      className="flex items-center justify-between h-16 px-6 border-b z-40 shrink-0 theme-gradient text-white shadow-blue"
    >
      <div className="flex items-center gap-4">
        ...
        <div>
            <h1 className="text-heading-sm" style={{ color: 'hsl(var(--header-foreground))' }}>{orgDetails.firmName || 'PetroPro'}</h1>
            <p className="text-body-sm" style={{ color: 'hsl(var(--header-foreground), 0.7)' }}>Welcome, {user?.user_metadata?.name || user?.email || 'User'}!</p>
        </div>
      </div>
      <div className="flex items-center space-x-1">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <div>
              <FloatingButton tooltip="ID Card Generator">
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>ID Card Generator</DialogTitle>
            </DialogHeader>
            <div className="text-center text-muted-foreground py-8">
              ID Card Generator feature will be available soon
            </div>
          </DialogContent>
        </Dialog>
        ...
        <Dialog>
          <DialogTrigger asChild>
            <div>
              <FloatingButton tooltip="Calculator">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <div>
              <FloatingButton tooltip="Todo List">
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="flex flex-col items-start">
                <span className="text-body-sm font-weight-medium" style={{ color: 'hsl(var(--header-foreground))' }}>
                  {user?.user_metadata?.name || 'User'}
                </span>
                <span className="text-caption" style={{ color: 'hsl(var(--header-foreground), 0.7)' }}>
                  {userRole || 'User'}
                </span>
              </div>
            </motion.div>
        ...
        {/* Version Display */}
         <div className="flex items-center px-3 py-1 rounded-md text-caption font-weight-medium ml-2" style={{
           backgroundColor: 'hsl(var(--header-background), 0.8)',
