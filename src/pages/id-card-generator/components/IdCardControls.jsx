...
const IdCardControls = ({ content, setContent, images, setImages, styles, setStyles, toolElements, setToolElements, templates, loadTemplate, deleteTemplate, employees, loadEmployeeData }) => {
  return (
            ...
            <div className="p-4">
              ...
              <TabsContent value="tools">
                <ToolsSettings
                  ...
                  setToolElements={setToolElements}
                />
              </TabsContent>
            </div>
          </ScrollArea>
